...
INFLUXDB_TOKEN = "6ESigniesYknb6CVDlhJrS-lhlp3cY2Cs0xCfM70LEUSwJ6KykUy3RTLFQWvtANCrKBZPCNpJZeKkCb9uxFOig=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "ntu"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "Lab-13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "172.20.10.8"  # ESP32's MQTT broker address
